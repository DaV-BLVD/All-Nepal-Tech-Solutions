...
@section('content')
    <div class="p-6 max-w-7xl mx-auto">
        ...
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight">⚙️ Service Management</h1>
        ...
        <div class="overflow-x-auto shadow-xl rounded-lg border border-gray-200">
            <table class="min-w-full bg-white divide-y divide-gray-200">
                ...
                <thead class="bg-primary text-white">
                    <tr>
                        <th class="px-4 py-3 text-left font-semibold text-sm uppercase tracking-wider w-1/3">Title</th>
                        <th class="px-4 py-3 text-center font-semibold text-sm uppercase tracking-wider w-20">Icon</th>
                        <th class="px-4 py-3 text-center font-semibold text-sm uppercase tracking-wider w-24">Status</th>
                    ...
                    @forelse($services as $service)
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-4 py-3 text-center">
                                <i class="{{ $service->icon }} text-xl text-indigo-600" title="{{ $service->icon }}"></i>
                            </td>
                            ...
                            <td class="px-4 py-3 text-center">
                                <div class="flex justify-center space-x-2">
                                    ...
                                    <form action="{{ route('services.destroy', $service) }}" method="POST"
                                        onsubmit="return confirm('Are you sure you want to delete the service: {{ $service->title }}?');"
                                        class="inline-block">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
                    ...
                    @empty
                        ...
                        <tr>
                            <td colspan="4" class="p-8 text-center text-gray-500 bg-gray-50">
                                <i class="fas fa-info-circle mr-2"></i> No Services found. Click
                                <strong>Add New Service</strong> above to get started.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
